...
let OriginFilePath = path.resolve(__dirname, 'pdf')
let CopyFilePath = path.resolve(__dirname, 'output')
...
const copypdf = () => getFiles(OriginFilePath, CopyFilePath)
...
// https://blog.csdn.net/aguqinwan/article/details/126045969